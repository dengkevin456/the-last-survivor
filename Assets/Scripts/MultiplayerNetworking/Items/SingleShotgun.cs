...
public class SingleShotgun : MultiplayerGun
{
    ...
    public override void AlternateUse()
    {
        ...
        {
            isAiming = true;
            playerCam.fieldOfView = Mathf.Lerp(playerCam.fieldOfView,  (float) pc.playerHash["cameraFOV"] - 30, 0.5f);
        }
        else
        {
            isAiming = false;
    ...
    private void Shoot()
    {
        ...
        if (newBullet != null && PhotonNetwork.IsMasterClient) StartCoroutine(DestroyBulletDelay(9, newBullet));
    }
}
